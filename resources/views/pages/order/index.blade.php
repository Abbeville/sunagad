...
<div class="section padding_layout_1 checkout_section">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-8">
        <form action="{{ route('order.create') }}" method="POST" id="customerForm" class="paymentForm">
          <div class="col-sm-12">
      ...
      <div class="col-md-4">
        <div class="shopping-cart-cart">
          <table>
            <tbody>
              <tr class="head-table">
                <td><h5>Your Order</h5></td>
                <td class="text-right"></td>
              </tr>
            </tbody>
          </table>
          @include('pages.order.partials.contents')
          <table>
            <tbody>
          ...
          {{-- <button class="bt_main" onclick="document.getElementById('customerForm').submit();">Place Order</button> --}}
          <input type="submit" name="" class="bt_main" value="Place Order">
        </div>
      </div>
      </form>
    </div>
